...
- Using the set, create a vector named *Ornacia*.
...
- Plot the weekly abundance of the Barred Owl, Canada Goose and Red Shouldered Hawk on a single line graph. 
...
5. Using your averaging function, write script to create a new dataframe containing the names and average abundance of every species that has an average abudnace greater than 5 individuals. Your resulting data frame should have two columns: the name of the species and their average abundance. 